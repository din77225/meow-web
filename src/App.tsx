          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-8 pt-8 border-t border-[#032b2e]/15">
                ...
                <div>
                  <p className="text-3xl font-black text-[#032b2e]">{channelData.members}</p>
                  <p className="text-xs uppercase tracking-widest text-[#7b54b3] font-bold mt-1">skool members</p>
                </div>
                <div>
                  <p className="text-3xl font-black text-[#032b2e]">{channelData.views}</p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div id="community" className="bg-white text-[#1a1625] px-6 py-14 lg:px-16 lg:py-20 flex flex-col justify-center border-r border-black/5">
            ...
            <p className="text-base lg:text-lg font-serif text-slate-500 italic max-w-sm mb-8 leading-relaxed">
              {channelData.members} creators sharing workflows, resources, and feedback every day. Come build in public.
            </p>
            <a
              href="https://www.skool.com/ai-creator-labs-2150"
              target="_blank"
